...
rem       tool\                           三个 exe + Qt + assets + 自检/clear
rem
rem 用法: 新建工程.bat <工程名>
setlocal
if "%~1"=="" (
...
echo     2. 双击 %NAME%\tool\UITools.exe，用"新建工程"建页面并保存
echo     3. 点工具栏的「资源导出」生成资源
echo     4. 按需改 project\copy_file.bat 里的两个路径
endlocal
