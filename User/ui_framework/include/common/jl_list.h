#ifndef __JL_LIST_H__
#define __JL_LIST_H__

#include "jl_typedef.h"

/* @note 本文件里的 __typeof__ 原为 GNU 的 typeof 关键字。Keil 工程是
 *       C99 严格模式(uGnu=0), 那个拼法不可用; __typeof__ 是同一扩展的
 *       保留标识符拼法, clang/armclang 在任何标准模式下都支持,
 *       所以不需要为此打开 GNU 扩展。 */
