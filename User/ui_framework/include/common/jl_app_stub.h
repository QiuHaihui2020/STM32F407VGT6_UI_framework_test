 ...
 * @brief   应用侧头文件的占位替代
 *
 * 框架的 lcd_drive/middle/ 几个文件 include 了音箱类工程的应用侧头:
 ...
 * lcd_ui_api.c 用 REGISTER_LP_TARGET 把"背光是否空闲"登记给平台的低功耗
 * 管理器, 让系统在背光亮着时不进休眠。
 *
 * STM32 侧没有对应的低功耗框架, 这里定义成一个【普通的未使用全局变量】:
 * 这类登记要靠 sec(.lp_target) 段收集, 本工程 sec() 是空宏, 不会生效 ——
