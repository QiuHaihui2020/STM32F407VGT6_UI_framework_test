...
/* DCX2496 界面, 一页一个文件, 在 User/dcx_ui_action/ 下。
 * 页序与 .uiproj 的 pages[] 一致(PAGE_0..PAGE_8), 语义别名见
 * dcx_ui_action/dcx_ui_action.h。 */
extern const struct ui_handler_group ui_handlers_dcx_boot;
extern const struct ui_handler_group ui_handlers_dcx_input;
extern const struct ui_handler_group ui_handlers_dcx_output;
extern const struct ui_handler_group ui_handlers_dcx_setup;
extern const struct ui_handler_group ui_handlers_dcx_sum;
extern const struct ui_handler_group ui_handlers_dcx_mute;
extern const struct ui_handler_group ui_handlers_dcx_recall;
extern const struct ui_handler_group ui_handlers_dcx_store;
extern const struct ui_handler_group ui_handlers_dcx_ptest;
...
/*	&ui_handlers_music,
    ...
    &ui_handlers_dcx_boot,
    &ui_handlers_dcx_input,
    &ui_handlers_dcx_output,
    &ui_handlers_dcx_setup,
    &ui_handlers_dcx_sum,
    &ui_handlers_dcx_mute,
    &ui_handlers_dcx_recall,
    &ui_handlers_dcx_store,
    &ui_handlers_dcx_ptest,
    NULL,   /* 结束标记 */
};
